...
#define HUDShowTime 1.5f//自动hide的HUD的默认显示时间
#define HUDOpacity 0.5f
...
+ (MBProgressHUD *)showTemporaryHUDWithType:(HUDTemporaryType)type addedTo:(UIView *)view text:(NSString *)text {
    return [MBProgressHUDWrap showTemporaryHUDWithType:type addedTo:view text:text duration:HUDShowTime completionBlock:nil];
}
...
+ (MBProgressHUD *)showTemporaryHUDWithType:(HUDTemporaryType)type addedTo:(UIView *)view text:(NSString *)text duration:(NSTimeInterval)duration {
    return [MBProgressHUDWrap showTemporaryHUDWithType:type addedTo:view text:text duration:duration completionBlock:nil];
}
...
+ (MBProgressHUD *)showTemporaryHUDWithType:(HUDTemporaryType)type addedTo:(UIView *)view text:(NSString *)text completionBlock:(MBProgressHUDCompletionBlock)completionBlock {
    return [MBProgressHUDWrap showTemporaryHUDWithType:type addedTo:view text:text duration:HUDShowTime completionBlock:completionBlock];
}
